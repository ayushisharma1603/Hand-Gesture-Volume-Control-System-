...
try:
    ...
    print("Run: pip install --upgrade pycaw comtypes")
except AttributeError as e:
    print(f"❌ Attribute Error: {e}")
    print("Try running PowerShell as Administrator")
except Exception as e:
    print(f"❌ Warning: Volume control not fully available: {e}")
    print("Camera will still work, but volume control may be limited")
...
print("="*50)
print("\n📍 GESTURE:")
print("  👍 Use Thumb & Index Finger Distance to Control Volume")
print("  ✌️  Close Distance = Lower Volume")
print("  🖐️  Far Distance = Higher Volume")
print("\n⌨️  Press 'Q' to quit\n")
print("="*50 + "\n")

class HandGestureVolumeControl:
    """
    Main application for hand gesture volume control.
    """
